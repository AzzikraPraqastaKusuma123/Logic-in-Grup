document.addEventListener('DOMContentLoaded', async () => {
        ...
        <div class="container page-wrapper">
            <section class="team-hero-layout">
                <div class="hero-details">
                    ...
                    <p id="member-role" class="role">Memuat Peran...</p>
    ...
    try {
        ...
        if (member.projects && Array.isArray(member.projects) && member.projects.length > 0) {
            ...
            document.getElementById('member-projects').innerHTML = projectsHTML;
            document.getElementById('projects-section').style.display = 'block';

            // ===== KONFIGURASI BARU YANG LEBIH MENARIK UNTUK PROJECT SLIDER =====
